...
function buildCharts() {
    ...
    d3.json("/getCountryData").then(function (countrysInfo) {
        // Use this link to get the geojson data.
        var link = "static/data/countries.geo.json";
        // Grabbing our GeoJSON data..
        d3.json(link, function (countryMapData) {
            updataJsonData(countryMapData,countrysInfo);
...
// function1: load data  
///////////////////////////////////////////////////////////////////////
function updataJsonData(countryMapData, countrysInfo) {
    ...
    countryMapData.features.forEach(countryInfo => {
        ...
        countrysInfo.filter(findCountry);
    })
